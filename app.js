...
const SAMPLE_DATA = {
  sampleUsers: [
    ...
    { id: "client1", username: "client001", password: "temp123", role: "client", name: "John Smith", company: "Tech Corp" },
    { id: "client2", username: "client002", password: "temp456", role: "client", name: "Sarah Johnson", company: "Design Studio Inc" },
    { id: "client3", username: "client003", password: "temp789", role: "client", name: "Mike Chen", company: "Startup Innovations" }
  ],
  sampleRequests: []
};
...
function handlePortalAccess(portal) {
  ...
  const title = portal === "admin" ? "Admin Login" : "Client Login";
...
// Global functions for portal access
function handlePortalAccess(portal) {
  currentPortal = portal;
